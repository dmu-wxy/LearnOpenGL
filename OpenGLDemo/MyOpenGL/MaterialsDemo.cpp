...
MaterialsDemo::MaterialsDemo(unsigned int screen_width, unsigned int screen_height) : IDemo(screen_width, screen_height) ,cubeVAO(-1),lightCubeVAO(-1),VBO(-1),pLightingShader(nullptr),pLightCubeShader(nullptr){}
...
void MaterialsDemo::init() {
    std::cout << "Demo init" << std::endl;

    // build and compile our shader zprogram
    // ------------------------------------
    pLightingShader = new Shader("2.2.basic_lighting.vs", "2.2.basic_lighting.fs");
...
void MaterialsDemo::draw(Camera camera, glm::vec3 lightPos) {
    // be sure to activate shader when setting uniforms/drawing objects
    pLightingShader->use();
    pLightingShader->setVec3("objectColor", 1.0f, 0.5f, 0.31f);
    pLightingShader->setVec3("lightPos", lightPos);
    pLightingShader->setVec3("viewPos", camera.Position);
    pLightingShader->setVec3("material.ambient", 1.0f, 0.5f, 0.31f);
    pLightingShader->setVec3("material.diffuse", 1.0f, 0.5f, 0.31f);
    pLightingShader->setVec3("material.specular", 0.5f, 0.5f, 0.5f);
